function cost_ret = optim_get_seq_cost_par(no_pe, pe_seq, seq_type, layer_struct)
%OPTIM_GET_SEQ_COST_PAR
%
% (Usage)
%
% (Examples)
...
parfor ii = 1:size(pe_seq,1)
    ...
    dd_conf_next = {zeros(i_vec) zeros(k_vec) zeros(o_vec)};
